...
class PlayViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        quitButton.setTitleColor(.choicebuttoncolor, for: .normal)
    ...
    func mcButtonSetUp(button: UIButton) -> Void{
        button.backgroundColor = .choicebuttoncolor
    ...
    func setToSelected(button: UIButton) -> Void{
        ...
        button.layer.borderColor = UIColor.borderslcolor.cgColor
        button.layer.shadowColor = UIColor.clear.cgColor
    }
    func setToCorrect(button: UIButton) -> Void{
        button.backgroundColor = .correctcolor
        button.layer.borderWidth = 3
        button.layer.borderColor = UIColor.bordercorrectcolor.cgColor
        button.layer.shadowColor = UIColor.clear.cgColor
    }
